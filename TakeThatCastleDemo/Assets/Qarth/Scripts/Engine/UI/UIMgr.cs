...
System.Reflection.BindingFlags.Public);
    ...
    where T : IConvertible
        ...
        private void SortActivePanelInfo()
        {
            ...
            {
                PanelInfo panelInfo = m_ActivePanelInfoList[i];
                if (panelInfo.abstractPanel != null /*&& panelInfo.uiID != (int)UIID.BlurMaskPanel*/)  //如果是Blur Mask Panel 就不用重新排列
                {
                    panelInfo.SetSiblingIndexAndSortingOrder(index++, sortingOrder);
                    sortingOrder = panelInfo.maxSortingOrder;
                }
            }
        }
...
#region 内部事件处理
        ...
        #endregion
        private GameObject m_CurrentSelectedObj;
#region Mono生命周期
        private void Update()
        {
        ...
        /// 多次连续点击限制逻辑
        /// </summary>
        //private void UpdateTopMaskPanel()
        //{
        //    if (Input.GetMouseButtonUp(0))
        //    {
        //        GameObject obj = UnityEngine.EventSystems.EventSystem.current.currentSelectedGameObject;
        //        if (obj != null && m_CurrentSelectedObj != obj)
        //        {
        //            m_CurrentSelectedObj = obj;
        //            OpenTopPanel(UIID.TopMaskPanel, null);
        //        }
        //    }
        //}
