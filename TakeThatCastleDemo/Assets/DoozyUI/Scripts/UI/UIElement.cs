...
namespace DoozyUI
{
    ...
    public class UIElement : MonoBehaviour
    {
        ...
        public void Init(bool isSingle)
        {
            Awake();
            OnEnable();
            Start(isSingle);
        ...
        /// Executes the inital setup for this UIElement.
        /// </summary>
        void SetupElement(bool isSingle)
        {
            if (GetComponentsInChildren<UIElement>().Length > 1)
            {
                containsChildUIElements = true;
            ...
            {
                UIManager.HideUiElement(elementName, elementCategory, true, isSingle);
            }
            else
            {
                //select the auto-select button
